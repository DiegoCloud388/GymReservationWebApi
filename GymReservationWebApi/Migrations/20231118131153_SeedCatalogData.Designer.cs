...
namespace GymReservationWebApi.Migrations
{
    ...
    [Migration("20231118131153_SeedCatalogData")]
            ...
            modelBuilder.Entity("GymReservationWebApi.Entities.CtlgReservationState", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2023, 11, 18, 14, 11, 53, 427, DateTimeKind.Local).AddTicks(9182),
                            EntityState = 1,
                            Name = "Reservováno"
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2023, 11, 18, 14, 11, 53, 427, DateTimeKind.Local).AddTicks(9217),
                            EntityState = 1,
                            Name = "Zrušeno"
                        });
                });
